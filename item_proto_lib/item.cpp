...
namespace item_proto_lib
{
    namespace item
    {
        ...
        CItemLimit::CItemLimit(const table::TItemLimit& itemLimit)
        {
        ...
        CItemApply::CItemApply(const table::TItemApply& itemApply)
        {
        ...
        CItem::CItem(const table::TItemTable & itemTable)
        {
