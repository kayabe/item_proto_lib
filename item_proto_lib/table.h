...
#pragma pack(1)
        ...
        typedef struct SItemTable
        {
            ...
            char        szName[cnst::ITEM_NAME_MAX_LEN + 1];
            char        szLocaleName[cnst::ITEM_NAME_MAX_LEN + 1];
            uint8_t     bType;
            uint8_t     bSubType;
            ...
            TItemLimit  aLimits[cnst::ITEM_LIMIT_MAX_NUM];
            TItemApply  aApplies[cnst::ITEM_APPLY_MAX_NUM];
            int32_t     alValues[cnst::ITEM_VALUES_MAX_NUM];
            int32_t     alSockets[cnst::ITEM_SOCKET_MAX_NUM];
